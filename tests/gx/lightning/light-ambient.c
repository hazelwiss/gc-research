...
static f32 light_strength = 32.0;
...
int main() {
  ...
  while (1) {
    ...
    light_strength = MIN(MAX(light_strength, 0), 255);

    GX_SetNumChans(1);
    GX_SetChanCtrl(GX_COLOR0A0, GX_ENABLE, GX_SRC_REG, GX_SRC_VTX, 0,
                   GX_DF_NONE, GX_AF_NONE);
    GX_SetChanAmbColor(GX_COLOR0A0, (GXColor){light_strength, light_strength,
                                              light_strength, 0xff});
